...
const TheFuture = () => {
  return (
    <Container>
      <Images>
        <Image background={"./src/images/img_1.jpg"}></Image>
        <Image background={"./src/images/img_2.jpg"}></Image>
        <Image background={"./src/images/img_4.png"}></Image>
        <Image background={"./src/images/img_3.jpg"}></Image>
      </Images>
      <TextBox>
